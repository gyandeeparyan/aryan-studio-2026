...
export default function Team() {
  return (
    <section id="team" className="bg-[#f5f5f5] py-24">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {team.map((member) => (
            <Card
              key={member.name}
              className="bg-white border border-[#e7e5e4] rounded-2xl shadow-none group hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-shadow duration-300 overflow-hidden"
            >
              <CardContent className="p-0">
                ...
                >
                  ...
                  />
                  <div className="relative z-10 w-14 h-14 rounded-full bg-white/80 backdrop-blur-sm border border-[#e7e5e4] flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
                    <span
                      className="text-[18px] tracking-[-0.01em] text-[#0c0a09]"
                      style={{
                ...
                {/* Info */}
                <div className="p-5">
                  <h3 className="text-[15px] font-medium text-[#0c0a09] leading-tight mb-0.5">
                    {member.name}
                  </h3>
                  <p className="text-[12px] font-medium text-[#777169] mb-3 tracking-[0.01em]">
                    {member.role}
                  </p>
                  <p className="text-[12px] leading-[1.6] text-[#4e4e4e]">
                    {member.bio}
                  </p>
                </div>
              </CardContent>
